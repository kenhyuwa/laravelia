            ...
            e += '<form id="menuUpdate" class="form-horizontal" action="'+ window.App.APP_ROUTE+'/'+ data.id +'" method="POST">';
                ...
                e += '<div class="box-body">';
                    ...
                    e += '<div class="form-group">';
                        ...
                        e += '<div class="col-sm-8">';
                            e += '<input type="text" class="form-control" id="id_name" placeholder="EN Name" name="id_name" autocomplete="off" value="'+ data.id_name +'">';
                        e += '</div>';
                    e += '</div>';
                    e += '<div class="form-group">';
                        e += '<label for="icon" class="col-sm-4 control-label">Icon</label>';
                        e += '<div class="col-sm-8">';
                            e += '<input type="text" class="form-control" id="icon" placeholder="EN Name" name="icon" autocomplete="off" value="'+ data.icon +'">';
                        e += '</div>';
                    e += '</div>';
                    e += '<div class="form-group">';
