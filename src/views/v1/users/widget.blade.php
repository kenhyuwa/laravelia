                ...
                <div class="col-md-4">
                    <div class="box box-widget widget-user">
                        <div class="widget-user-header bg-aqua-active">
                            <span>
                                <button data-id="{{ in_array($v->roles[0]['name'], [config('litepie.first_class')]) ? '' : $v->id }}" type="button" class="btn btn-xs btn-flat btn-info _edit" {{ auth()->user()->canUpdateUsers() && !in_array($v->roles[0]['name'], [config('litepie.first_class')]) ? '' : 'disabled' }}>
                                    <i class="fa fa-edit" {{ tooltip('Edit', 'bottom') }}></i>
                                </button>
                            </span>
                            <span>
                                <button data-id="{{ in_array($v->roles[0]['name'], [config('litepie.first_class')]) ? '' : $v->id }}" type="button" class="btn btn-xs btn-flat btn-danger _destroy" {{ auth()->user()->canDestroyUsers() && !in_array($v->roles[0]['name'], [config('litepie.first_class')]) ? '' : 'disabled' }}>
